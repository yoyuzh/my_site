...
- Prefer documenting commands that already exist in `frontend/package.json`, `backend/pom.xml`, `backend/README.md`, `README.md`, or checked-in script files.
...
- Keep plan or handoff documents tied to actual repo paths like `backend/...`, `frontend/...`, `scripts/...`, and `docs/...`.
