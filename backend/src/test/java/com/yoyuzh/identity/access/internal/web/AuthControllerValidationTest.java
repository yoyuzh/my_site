...
import com.yoyuzh.identity.access.internal.web.AuthController;
...
class AuthControllerValidationTest {
    ...
    void shouldExposeRefreshEndpointContract() throws Exception {
        ...
        when(authService.refresh("refresh-1", IdentityClientType.DESKTOP)).thenReturn(response);
        ...
        verify(authService).refresh("refresh-1", IdentityClientType.DESKTOP);
    }
}
