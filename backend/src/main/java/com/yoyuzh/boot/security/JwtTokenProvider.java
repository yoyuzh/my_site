...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(Long userId, String username, String sessionId) {
        return generateAccessToken(userId, username, sessionId, IdentityClientType.DESKTOP);
    }

    public String generateAccessToken(Long userId, String username, String sessionId, IdentityClientType clientType) {
    ...
    public IdentityClientType getClientType(String token) {
        Object clientType = parseClaims(token).get("client");
        return IdentityClientType.fromHeader(clientType == null ? null : clientType.toString());
    }
