...
public final class WorkspaceNodeRulesService {
    ...
    public void ensureDirectoryHierarchy(User user, String normalizedPath) {
        workspacePathPolicy.ensureDirectoryHierarchy(user, normalizedPath);
    }
    ...
    public void validateRecycleRestoreTargets(Long userId,
        ...
        workspacePathPolicy.validateRecycleRestoreTargets(userId, recycleGroupItems, recycleOriginalPathResolver);
    }
}
